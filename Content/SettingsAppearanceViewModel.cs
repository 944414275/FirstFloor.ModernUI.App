...
namespace FirstFloor.ModernUI.App.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.selectedFontFamily = AppearanceManager.Current.AccentFontFamily.ToString();
            SyncThemeAndColor();
        ...
        public string SelectedFontFamily
        {
            ...
            set {
                if (this.selectedFontFamily != value)
                {
                    ...
                    AppearanceManager.Current.AccentFontFamily = (FontFamily)fontfamilyConverter.ConvertFromString(value);
                }
            }
        }
